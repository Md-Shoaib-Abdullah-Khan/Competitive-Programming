...
void solve()
{
    ...
    cin>>l>>r;
   max_steps=0;
    for(i=l;i<=r;i*=2)max_steps++;
    memset(vis,0,sizeof(vis));

    int ans=0;
    for(i=l;i<2*l;i++)ans+=rec(i,r,false,1);
//     steps--;
...
//    int ans= (r/power(2,steps)) - l + 1;
//    ans= ans + max(0,((r/(power(2,steps-1)*3))-l+1)*steps);

//    cout<<steps+1<<" "<<ans<<endl;
cout<<max_steps<<" "<<ans<<endl;
